...
$.tzUpload = function(options){
	...
	var settings = {
		flash_url : basePath+"/resources/js/swfupload/swfupload.swf",//指明文件上传的flash文件
		flash9_url : basePath+"/resources/js/swfupload/swfupload_fp9.swf",//新版的flash文件
		...
		file_post_name:opts.postName,//提交给后台的File对象
		...
		debug: false,//显示控制台
		// Button settings
		button_image_url: opts.img,//上传文件的图片
		button_width: "61",//图片的宽度
		button_height: "22",//图片的高度
		button_action:opts.single?SWFUpload.BUTTON_ACTION.SELECT_FILE:SWFUpload.BUTTON_ACTION.SELECT_FILES,//控制文件是否多选SWFUpload.BUTTON_ACTION.SELECT_FILE(单文件上传去掉S)
...
$.tzUpload.defaults = {
	targetId:"uploadBtn",	
	uploadBox:"",
	url:basePath+"/otherupload/upload.do",
	size:"10 MB",
	type:"*.*",
	postName:"file",
	queueLimit:100,
	...
	single:false,
	htmlbox:"",
	img:basePath+"/resources/js/swfupload/imagebtn.png",
	reload:function(){
